...
import com.example.lab7.viewmodels.SeeCardViewModel
import com.example.lab7.databinding.FragmentSeeCardBinding

class SeeCardFragment : Fragment() {
    private var _binding: FragmentSeeCardBinding? = null
    private val binding get() = _binding!!
    private val args by navArgs<com.example.lab7.fragments.SeeCardFragmentArgs>()
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            editButton.setOnClickListener {
                val navAction =
                    com.example.lab7.fragments.SeeCardFragmentDirections.actionSeeCardFragmentToEditCardFragment(
                        cardId
                    )
            ...
            backButton.setOnClickListener {
                val navAction =
                    com.example.lab7.fragments.SeeCardFragmentDirections.actionSeeCardFragmentToListCardFragment()
                findNavController().navigate(navAction)
            }
