...
import com.example.lab7.utilities.ActionInterface
import com.example.lab7.viewmodels.ListCardViewModel
import com.example.lab7.adapters.CustomRecyclerAdapter
...
class ListCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.addbuttonid.setOnClickListener {
            val navAction =
                com.example.lab7.fragments.ListCardFragmentDirections.actionListCardFragmentToEditCardFragment(
                    -1
                )
    ...
    private val action = object : ActionInterface {
        override fun onItemClick(cardId: Int) {
            val action =
                com.example.lab7.fragments.ListCardFragmentDirections.actionListCardFragmentToSeeCardFragment(
                    cardId
                )
